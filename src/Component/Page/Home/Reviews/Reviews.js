    ...
    return (
        <div className='lg:w-full mx-auto'>
            ...
            <div >
                ...
                {
                    reviews.map(review => <div key={review._id} data-aos='flip-up' data-aos-duration='600' className='m-16 border border-red-700 rounded-lg p-3 w-2/3 mx-auto flex items-center' >
                        {/* style={{ width: '90px' }} */}
                        {/*  */}
